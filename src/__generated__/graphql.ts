...
export type CreateChatMutation = {
  __typename?: 'Mutation';
  createChat: { __typename?: 'Chat'; _id: string };
};
...
export type OnRequestAddedSubscriptionVariables = Exact<{
  [key: string]: never;
}>;

export type OnRequestAddedSubscription = {
  __typename?: 'Subscription';
  OnRequestAdded: {
    __typename?: 'RequestData';
    request: {
...
export type OnRequestUpdatedSubscriptionVariables = Exact<{
  [key: string]: never;
}>;

export type OnRequestUpdatedSubscription = {
  __typename?: 'Subscription';
  OnRequestUpdated: {
    __typename?: 'RequestData';
    request: {
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
        ...
        },
        {
          ...
          variable: {
            kind: 'Variable',
            name: { kind: 'Name', value: 'friendUserId' },
          },
          type: {
            kind: 'NonNullType',
            type: {
...
>;
export const PendingRequestsDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
...
export const OnRequestAddedDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'subscription',
      name: { kind: 'Name', value: 'OnRequestAdded' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
  ...
  OnRequestAddedSubscription,
  OnRequestAddedSubscriptionVariables
>;
export const OnRequestUpdatedDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'subscription',
      name: { kind: 'Name', value: 'OnRequestUpdated' },
      selectionSet: {
        kind: 'SelectionSet',
        selections: [
          {
  ...
  OnRequestUpdatedSubscription,
  OnRequestUpdatedSubscriptionVariables
>;
